...
from ta_taxonomies.suites.sfia.db import neo4j_driver, verify_connectivity

SKIP_REASON = "Neo4j not available (see src/ta_taxonomies/suites/sfia/NOTES.md)"


def neo4j_available() -> bool:
    if not (os.getenv("SFIA_NEO4J_PASSWORD") or os.getenv("NEO4J_PASSWORD")):
        return False
    try:
